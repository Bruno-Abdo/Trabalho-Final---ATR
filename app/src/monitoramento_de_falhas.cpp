...
{
    std::cout << "Monitoramento " << id << " is starting." << std::endl;
    try
    {
        ...
        while (running_flag)
        {
            ...
            //std::cout << "[LOG] " << "Monitoramento " << id << " is running..." << std::endl;
    ...
    catch (const boost::thread_interrupted &)
    {
        ...
        std::cout << "Monitoramento " << id << " was interrupted." << std::endl;
    }

    std::cout << "Monitoramento " << id << " is stopping." << std::endl;
}
